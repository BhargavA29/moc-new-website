    ...
    return (
        <>
            ...
            <tr className="border-b border-white/10">
                ...
                <td className="py-2">159K+ Followers</td>
            </tr>
        </>
    );
}
            ...
            <div className="max-w-[1400px] mx-auto px-4 py-8">
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-grow">
                        <h1 className="text-4xl text-[#FFC857] font-black mb-4">MOHIT YODHA</h1>
                            ...
                            <table className="w-full text-sm">
                                <tbody>
                                    ...
                                    <tr className="border-b border-white/10">
                                        ...
                                        <td className="py-2">
                                            <a href="https://www.youtube.com/@comicverseog"
                                                className="text-[#FFC857] hover:underline">ComicVerse ↗</a>
                                            <br />
                                            <a href="https://www.youtube.com/@Flickverseyt"
                                                className="text-[#FFC857] hover:underline">FlickVerse ↗</a>
                                            <br />
                                            <a href="https://www.youtube.com/@Mohitverse"
                                                className="text-[#FFC857] hover:underline">MohitVerse ↗</a>
                                        </td>
                                    </tr>
                                    <tr className="border-b border-white/10">
                                    ...
                                    <tr className="border-b border-white/10">
                                        ...
                                        <td className="py-2">
                                            <a href="https://www.instagram.com/comicverseyt/"
                                                className="text-[#FFC857] hover:underline">Instagram ↗</a>
                                            <br />
                                            <a href="https://x.com/comicverseyt"
