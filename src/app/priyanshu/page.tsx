    ...
    return (
        <>
            ...
            <tr className="border-b border-white/10">
                ...
                <td className="py-2">58K+ Followers</td>
            </tr>
        </>
    );
}
        ...
        <main className="min-h-screen bg-[#0d1117] text-white/90">
            ...
            <div className="px-3 md:px-0">
                ...
                <div className="max-w-[1400px] mx-auto px-4 py-8">
                    ...
                    <h1 className="text-4xl text-[#FFC857] font-black mb-4 md:text-left text-center">PRIYANSHU JAISWAL</h1>
                                        ...
                                        <tr className="border-b border-white/10">
                                            ...
                                            <td className="py-2">
                                                <a href="https://www.youtube.com/channel/UCWkHlUiYLeRSIMP8yM7rxxg"
                                                    className="text-[#FFC857] hover:underline block">PJ Explained ↗</a>
                                                <a href="https://www.youtube.com/channel/UCbPUDwXjjV7KOYGdz3tLpXw"
                                                    className="text-[#FFC857] hover:underline block">thePJ ↗</a>
                                            </td>
                                        </tr>
                                        <tr className="border-b border-white/10">
